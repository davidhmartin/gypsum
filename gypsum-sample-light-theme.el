;;; gypsum-sample-light-theme.el --- Gypsum-Sample-Light Light Theme theme -*- lexical-binding: t; -*-
...
;; 1. Strings (#548F24)
;; 2. Constants (#6B2E9E)
;; 3. Comments (#A32F29) - prominent, NOT dimmed
;; 4. Definitions (#396DAC)
;;
;; Everything else uses the default foreground. This is intentional.

;;; Code:

(deftheme gypsum-sample-light
  "Light gypsum-sample-light theme - Alabaster-style minimal highlighting.
...
(provide-theme 'gypsum-sample-light)

;;; gypsum-sample-light-theme.el ends here
